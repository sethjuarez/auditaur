...
3. Merging the release PR runs release-plz publish for changed Rust crates.
...
3. Use Conventional Commits so release-plz and release-please can calculate semantic versions consistently.
